    ...
    <div className="max-w-4xl mx-auto px-6 space-y-6">
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <p className="text-sm text-gray-500">Private Publisher ƒ?› {plan} plan</p>
...
function PaymentPageFallback() {
  return (
    <div className="max-w-4xl mx-auto px-6">
      <div className="h-[32rem] rounded-3xl border border-dashed border-gray-200 bg-white/40 animate-pulse" />
    </div>
  );
}
