        ...
        <div className="max-w-xl mx-auto px-6 w-full">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              You selected the <span className="font-semibold text-gray-900">{plan}</span> plan. Sit tight while
              we securely redirect you to the payment provider.
            </p>
            ...
            <div className="mt-6 text-xs text-gray-400 flex items-center justify-center gap-2">
              ...
              PCI-compliant • SSL encrypted • Hosted checkout
            </div>
          </motion.div>
        </div>
      </main>
